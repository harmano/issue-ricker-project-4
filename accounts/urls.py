...
from accounts.views import logout, login, registration, user_profile, home, cart2, get_posts, post_detail, create_or_edit_post, community, get_feats, feat_detail, create_or_edit_feat
